    ...
    <div class="z-2">
      ...
      >
        <div style="min-width: 24px">
          ...
          <svg v-if="category.state === 'UNCHECKED'" class="fill-current text-darkGray" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
      ...
      <custom-button class="w-100 bg-green cursor-pointer" @click.stop="navigateTowardsPassport(visum.id)" :extraStyle="'w-100'" :text="t('passport.view-passport')"> </custom-button>
    </div>
  </div>
</template>
