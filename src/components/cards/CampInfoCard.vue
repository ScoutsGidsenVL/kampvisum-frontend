<template>
    <div @click="navigateTowardsCamp(camp)" class="p-3 cursor-pointer shadow-md rounded-md hover:bg-lighterGreen">
      <div class="z-2">
        ...
        <div v-for="category in categories" :key="category" class="d-flex gap-3 my-2.5 items-center	">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M 12 2 c 5.514 0 10 4.486 10 10 s -4.486 10 -10 10 s -10 -4.486 -10 -10 s 4.486 -10 10 -10 z m 0 -2 c -6.627 0 -12 5.373 -12 12 s 5.373 12 12 12 s 12 -5.373 12 -12 s -5.373 -12 -12 -12 z z"/></svg>
          ...
          <h4 @click.stop="navigateTowardsCategory()" class="hover:underline mb-0 ml-0" >{{ category }}</h4>
        </div>
      </div>
    </div>
</template>
