<template>
  <div @click="navigateTowardsCamp()" class="p-3 cursor-pointer shadow-md rounded-md hover:bg-lighterGreen">
    <div class="z-2">
      ...
      <h1>{{camp.name}}</h1>
      <div v-for="category in camp.categories" :key="category" class="d-flex gap-5">
...
export default defineComponent({
  ...
  setup () {
    ...
    const navigateTowardsCamp = () => {
      console.log('navigate to camp page by id')
    }
