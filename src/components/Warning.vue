...
<div v-if="isDisplayed" class="h-full w-full fixed top-0 left-0 overflow-x-hidden bg-black bg-opacity-20 custom-index">
  <div class="flex h-screen justify-center items-center">
    ...
    <div class="bg-white px-4 pb-4 sm:p-6 sm:pb-4" :class=" leftButton || rightButton ? 'pt-5' : ''">
      <div class="sm:flex sm:items-start">
        <div class="mt-3 mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-lightRed sm:mx-0 sm:h-10 sm:w-10">
