    ...
    <div class="container">
      <div class="footer-bottom__info row mb-4">
        <div class="col-12 col-lg-6">
          <div id="block-scouts-footer-address-block" class="block">
            <div class="footer-contact__address d-flex align-items-end">
              <div class="footer-contact__address__logo">
                <a href="/" aria-label="Scouts en gidsen Vlaanderen"
              ...
              <div class="footer-contact__address__address">
                <p>
                  Scouts en Gidsen Vlaanderen vzw<br />Wilrijkstraat 45, 2140 Antwerpen<br />RPR Antwerpen - 0407.138.494<br /><a href="mailto:info@scoutsengidsenvlaanderen.be"
        ...
        <div class="col-12 col-lg-6 d-lg-flex align-items-lg-end justify-content-lg-end mt-3 mt-md-4 mt-lg-0">
          <div id="block-scouts-footer-partners-block" class="block">
            <div class="footer-contact__partners d-flex mt-3 mt-md-0 align-items-center">
              ...
              <div class="footer-contact__partner">
                <div>
                  <a href="https://www.vlaanderen.be/nl" aria-label="Vlaanderen" rel="noopener" target="_blank"
                    ><div>
                      <img
                        sizes="100vw"
              ...
              <div class="footer-contact__partner">
                <div>
                  <a href="https://www.watwat.be/" aria-label="WatWat" rel="noopener" target="_blank"
                    ><div>
                      <img
                        sizes="100vw"
      ...
      <div class="footer-bottom__legal row small text-white">
        <div class="footer-bottom__legal__nav col-12 col-md-6 d-flex justify-content-md-end order-md-2">
