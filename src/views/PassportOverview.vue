<template>
  <div v-if="visum" class="p-3">
    ...
    <passport-overview-item :title="'Documenten'" :navText="'Alle documenten'" :navUrl="'documenten'" :visum="visum" />
    <passport-overview-item :title="'Locaties'" :navText="'Alle locaties'" :navUrl="'locaties'" :visum="visum" />
    <passport-overview-item :title="'Leden'" :navText="'Alle leden'" :navUrl="'leden'" :visum="visum" />
