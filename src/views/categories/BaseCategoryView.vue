  ...
  <div class="flex w-100 -mt-3">
    <div class="w-100">
      ...
      <div v-if="camp" class="w-100 flex pt-3">
          <div class="w-100">
            <base-subcategory-card :camp="camp" class="mb-3" title="Locatie(s)" titleTextfield="Opmerkingen" :concerns="['DateCheck', 'Message', 'SimpleCheck', 'InputCheck', 'LocationCheck', 'FileUploadCheck', 'MembersCheck']" @openSidebar="openSidebar()" />
